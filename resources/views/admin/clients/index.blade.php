	...
	<div class="kt-subheader  kt-grid__item" id="kt_subheader">
		<div class="kt-container  kt-container--fluid ">
			<div class="kt-subheader__main">
				<h3 class="kt-subheader__title">Клиенты</h3>
				<span class="kt-subheader__separator kt-subheader__separator--v"></span>
				<span class="kt-subheader__desc">{{ $clients->count() }} языков</span>
				<a href="{{ route('clients.create') }}" class="btn btn-label-warning btn-bold btn-sm btn-icon-h kt-margin-l-10">
					Добавить язык
				</a>
				...
				<div class="kt-portlet__head-toolbar">
					<div class="kt-portlet__head-wrapper">
						<div class="kt-portlet__head-actions">
							<a href="{{ route('clients.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
							...
							<td nowrap>
								...
								<span class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right">
										<a class="dropdown-item" href="#" data-toggle="modal" data-target="#menu_destroy-{{$client->id}}"><i class="la la-trash"></i> Удалить</a>
									</div>
								</span>
							</td>
						</tr>
...
@foreach($clients as $client)
<div class="modal fade" id="menu_destroy-{{$client->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Вы действительно хотите удалить клиента <span class="kt-badge kt-badge--dark  kt-badge--inline kt-badge--pill">{{ $client->name }}</span>?</p>
			</div>
