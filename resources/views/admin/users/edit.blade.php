										...
										<div class="kt-section__body">
											<div class="row">
												...
												<div class="col-lg-9 col-xl-6">
													<h3 class="kt-section__title kt-section__title-sm">Информация о пользователе:</h3>
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="col-lg-9 col-xl-6">
													<div class="kt-avatar kt-avatar--outline kt-avatar--circle-" id="kt_user_edit_avatar">
														<div class="kt-avatar__holder" style="background-image: url('{{ $user->getImage() }}');"></div>
											...
											<div class="form-group row">
												...
												<div class="col-lg-9 col-xl-6">
													<input class="form-control" type="text" name="first_name" value="{{ $user->first_name }}" placeholder="Введите имя">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-xl-3 col-lg-3 col-form-label">Фамилия</label>
												<div class="col-lg-9 col-xl-6">
													<input class="form-control" type="text" name="last_name" value="{{ $user->last_name }}" placeholder="Введите фамилию">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-xl-3 col-lg-3 col-form-label">Email</label>
												<div class="col-lg-9 col-xl-6">
													<input class="form-control" type="text" name="email" value="{{ $user->email }}" placeholder="Введите email">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-xl-3 col-lg-3 col-form-label">Новый пароль</label>
												<div class="col-lg-9 col-xl-6">
													<input class="form-control" type="password" name="password" placeholder="Введите новый пароль">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-xl-3 col-lg-3 col-form-label">Повторите пароль</label>
												<div class="col-lg-9 col-xl-6">
													<input class="form-control" type="password" name="password_confirmation" placeholder="Повторите новый пароль">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-xl-3 col-lg-3 col-form-label">Группа пользователя</label>
												<div class="col-lg-9 col-xl-6">
													<select class="form-control" name="admin">
														...
														@else
															@if(Auth::user()->admin == 1)
																<option value="1" @if($user->admin == 1) checked @endif>Суперпользователь</option>
															@endif
															<option value="2" @if($user->admin == 2) checked @endif>Администратор</option>
															<option value="3" @if($user->admin == 3) checked @endif>Редактор</option>
														@endif
