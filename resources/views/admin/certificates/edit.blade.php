	...
	<div class="kt-subheader   kt-grid__item" id="kt_subheader">
		<div class="kt-container  kt-container--fluid ">
			...
			<div class="kt-subheader__toolbar">
				<a href="{{ route('certificates.index') }}" class="btn btn-default btn-bold">
					Назад </a>
				<div class="btn-group">
									...
									<div class="kt-section kt-section--first">
										<div class="kt-section__body">
											<div class="form-group row">
												<label class="col-xl-3 col-lg-3 col-form-label">Иконка</label>
												<div class="col-lg-9 col-xl-6">
													<div class="custom-file">
														<div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
															<div class="kt-avatar__holder" style="background-image: url('{{ $certificate->getIcon() }}'); background-size: 100% auto; background-position: center;"></div>
												...
												<div class="col-lg-9 col-xl-6">
													<div class="custom-file">
														<div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_2">
															<div class="kt-avatar__holder" style="background-image: url('{{ $certificate->getImage() }}'); background-size: 100% auto; background-position: center;"></div>
															<label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="Сменить логотип">
															<i class="fa fa-pen"></i>
											...
											<div class="form-group row">
												...
												<div class="col-lg-9 col-xl-6">
													<input class="form-control" type="text" name="title" value="{{ $certificate->title }}" placeholder="Введите имя">
													<input type="hidden"
