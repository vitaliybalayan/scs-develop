...
{{Form::open(['route'	=>	'certificates.store', 'files'	=>	true])}}
	<!-- begin:: Content Head -->
									...
									<div class="kt-section kt-section--first">
										<div class="kt-section__body">
											...
											<div class="form-group row">
												...
												<div class="col-lg-9 col-xl-6">
													<input class="form-control" type="text" name="title" value="{{ old('title') }}" placeholder="Введите имя">
													<input type="hidden"
