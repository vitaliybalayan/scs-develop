									...
									<div class="kt-section__body">
										...
										<div class="form-group row">
											...
											<div class="col-lg-9 col-xl-6">
												<input class="form-control" type="text" name="locale[{{ $lang->code }}][title]" placeholder="Введите заголовок" value="{{ $fact->getLocalize($default_lang, 'title') }}">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9 col-xl-6">
												<input class="form-control" type="text" name="locale[{{ $lang->code }}][subtitle]" placeholder="Введите заголовок" value="{{ $fact->getLocalize($default_lang, 'subtitle') }}">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9 col-xl-6">
												<input class="form-control" type="text" name="locale[{{ $lang->code }}][desc]" placeholder="Введите описание" value="{{ $fact->getLocalize($default_lang, 'desc') }}">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9 col-xl-6">
												<input class="form-control" type="text" name="locale[{{ $lang->code }}][text_link]" placeholder="Введите текст ссылки" value="{{ $fact->getLocalize($default_lang, 'text_link') }}">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9 col-xl-6">
												<input class="form-control" type="text" name="locale[{{ $lang->code }}][link]" placeholder="Вставьте ссылку" value="{{ $fact->getLocalize($default_lang, 'link') }}">
											</div>
										</div>
							...
							<div class="kt-section kt-section--first">
								<div class="kt-section__body">
									<div class="form-group row">
										...
										<div class="col-lg-9 col-xl-6">
											<input class="form-control" type="text" name="position" placeholder="Установите порядок" value="{{ $fact->position }}">
										</div>
									</div>
