	...
	<div class="kt-subheader   kt-grid__item" id="kt_subheader">
		<div class="kt-container  kt-container--fluid ">
			...
			<div class="kt-subheader__toolbar">
				<a href="{{ route('articles.index') }}" class="btn btn-default btn-bold">Назад</a>
				<div class="btn-group">
									...
									<div class="form-group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
												<div class="kt-avatar__holder" style="background-image: url('{{ $article->getImage() }}'); background-size: 100% auto; background-position: center;"></div>
							...
							<div class="kt-form__body">
								<div class="kt-section kt-section--first">
									...
									<div class="kt-section__body">
										...
										<div class="form-group row">
											<label class="col-xl-3 col-lg-3 col-form-label">Название статьи</label>
											<div class="col-lg-9 col-xl-6">
												<input class="form-control" type="text" name="locale[{{ $lang->code }}][title]" id="{{ $lang->code }}_title" placeholder="Название статьи" value="{{ $article->getLocalize($lang->code, 'title') }}">
											</div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control" type="text" name="locale[{{ $lang->code }}][slug]" id="{{ $lang->code }}_slug" placeholder="Ссылка" value="{{ $article->getLocalize($lang->code, 'slug') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <textarea name="locale[{{ $lang->code }}][desc]" class="form-control" id="kt_autosize_2">{!! $article->getLocalize($lang->code, 'desc') !!}</textarea>
                                            </div>
                                        </div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9 col-xl-6">
                                            <textarea class="summernote" id="summernote" name="locale[{{ $lang->code }}][content]">{!! $article->getLocalize($lang->code, 'meta_tags') !!}</textarea>
											</div>
                                        </div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9 col-xl-6">
                                            <input class="form-control" type="text" name="locale[{{ $lang->code }}][meta_tags]" value="{{ $article->getLocalize($lang->code, 'meta_tags') }}" placeholder="Введите мета-теги через запятую">
											</div>
										</div>
									</div>
									...
									<div class="form-group form-group-sm row">
										...
										<div class="col-lg-9 col-xl-6">
											<span class="kt-switch">
												<label>
													<input type="checkbox" @if ($article->is_public == 1)
                                                        checked="checked"
