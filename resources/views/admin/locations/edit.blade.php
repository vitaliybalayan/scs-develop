									...
									<div class="kt-section__body">
										...
										<div class="form-group row">
											...
											<div class="col-lg-9 col-xl-6">
												<input class="form-control" type="text" placeholder="Введите город" name="locale[{{ $lang->code }}][city]" value="{{ $location->getLocalize($lang->code, 'city') }}">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9 col-xl-6">
												<textarea name="locale[{{ $lang->code }}][address]" class="form-control" id="kt_autosize_2">{{ $location->getLocalize($lang->code, 'address') }}</textarea>
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9 col-xl-6">
												<input class="form-control" type="text" placeholder="Введите email города" name="locale[{{ $lang->code }}][email]" value="{{ $location->getLocalize($lang->code, 'email') }}">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9 col-xl-6">
												<input class="form-control" type="text" placeholder="Введите телефон города" name="locale[{{ $lang->code }}][phone]" value="{{ $location->getLocalize($lang->code, 'phone') }}">
											</div>
										</div>
							...
							<div class="kt-section kt-section--first">
								<div class="kt-section__body">
									<div class="form-group row">
										...
										<div class="col-lg-9 col-xl-6">
											<input class="form-control" type="text" name="position" placeholder="Установите порядок" value="{{ $location->position }}">
										</div>
									</div>
									<div class="row">
									...
									<div class="form-group form-group-sm row">
										...
										<div class="col-lg-9 col-xl-6">
											<span class="kt-switch">
												<label>
													<input type="checkbox" @if($location->is_public == 1) checked="checked" @endif name="is_public">
													<span></span>
												</label>
											</span>
										</div>
